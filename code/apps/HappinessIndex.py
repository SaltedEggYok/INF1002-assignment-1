...
fig2018head = px.bar(data_frame=df18_head, x = 'Country', y= 'Score 2018',text = 'Score 2018', color = 'Country')
fig2018head.update_traces(textposition = 'outside')
fig2018tail = px.bar(data_frame=df18_tail, x = 'Country', y= 'Score 2018',text = 'Score 2018', color = 'Country')
...
fig2019head = px.bar(data_frame=df19_head, x = 'Country', y= 'Score 2019',text = 'Score 2019', color = 'Country')
fig2019head.update_traces(textposition = 'outside')
fig2019tail = px.bar(data_frame=df19_tail, x = 'Country', y= 'Score 2019',text = 'Score 2019', color = 'Country')
...
fig2020head = px.bar(data_frame=df20_head, x = 'Country', y= 'Score 2020',text = 'Score 2020', color = 'Country')
fig2020head.update_traces(textposition = 'outside')
fig2020tail = px.bar(data_frame=df20_tail, x = 'Country', y= 'Score 2020',text = 'Score 2020', color = 'Country')
...
fig2021head = px.bar(data_frame=df21_head, x = 'Country', y= 'Score 2021',text = 'Score 2021', color = 'Country')
fig2021head.update_traces(textposition = 'outside')
fig2021tail = px.bar(data_frame=df21_tail, x = 'Country', y= 'Score 2021',text = 'Score 2021', color = 'Country')
...
figWHR = px.bar(data_frame=df_WHR, y=[df_WHR[0],df_WHR[1],df_WHR[2],df_WHR[3]], text=[df_WHR[0],df_WHR[1],df_WHR[2],df_WHR[3]])
#figWHR.show()
